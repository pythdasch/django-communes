...
"""
django-communes documentation build configuration file.
...
project = 'django-communes'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'django-communes'
...
#
# html_title = 'django-communes v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'django-communes to import commune.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'django_communes'),
                os.path.join(root_path, 'django_communes/migrations')])
